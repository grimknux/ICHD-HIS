...
<div class="block">
    <div class="block-title text-right d-flex justify-content-between align-items-center">
        ...
        <div class="block-options">
            <button type="button" class="btn btn-effect-ripple btn-primary updateBtn"><i class="fa fa-floppy-o"></i> Update Patient</button>
            <a href="<?= base_url('patient/view') ?>" id="backBtn" class="btn btn-effect-ripple btn-default"><i class="fa fa-arrow-left"></i> Go back</a>
        </div>
    ...
    <form method="post" id="updatePatientForm">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" id="pat_fullname" name="pat_fullname" class="form-control" placeholder="Fullname" value="<?= esc($pat_edit_fullname) ?>" readonly>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group pat_lname">
                            ...
                            <input type="text" id="pat_lname" name="pat_lname" class="form-control" placeholder="Lastname" value="<?= esc($pat_edit_lname) ?>">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group pat_fname">
                            ...
                            <input type="text" id="pat_fname" name="pat_fname" class="form-control" placeholder="Firstname" value="<?= esc($pat_edit_fname) ?>">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group pat_mname">
                            ...
                            <input type="text" id="pat_mname" name="pat_mname" class="form-control" placeholder="Middlename" value="<?= esc($pat_edit_mname) ?>">
                ...
                <div class="row">
                    <div class="col-sm-3">
                        <div class="form-group pat_bdate">
                            ...
                            <input type="date" id="pat_bdate" name="pat_bdate" class="form-control" placeholder="mm/dd/yyyy" value="<?= $pat_edit_bdate ?>">
                    ...
                    <div class="col-sm-1">
                        <div class="form-group">
                            ...
                            <input type="text" id="pat_year" class="form-control" value="<?= $pat_edit_age_year ?>" readonly>
                        </div>
                    </div>
                    <div class="col-sm-1">
                        <div class="form-group">
                            <label for="pat_month">Month</label>
                            <input type="text" id="pat_month" class="form-control" value="<?= $pat_edit_age_month ?>" readonly>
                        </div>
                    </div>
                    <div class="col-sm-1">
                        <div class="form-group">
                            <label for="pat_day">Day</label>
                            <input type="text" id="pat_day" class="form-control" value="<?= $pat_edit_age_day ?>" readonly>
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <select class="select-select2 form-control select-sm" id="pat_suffix" name="pat_suffix">
                                ...
                                <?php foreach($getsuffix as $suffix): ?>
                                    <option value="<?= esc($suffix['suffix_code'])?>" <?= ($suffix['suffix_code'] == $pat_edit_suffix) ? "selected" : "" ?>><?= esc($suffix['suffix'])?></option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="form-group pat_sex">
                            ...
                            <select class="select-select2 form-control select-sm" id="pat_sex" name="pat_sex">
                                ...
                                <?php foreach($getsex as $sex): ?>
                                    <option value="<?= esc($sex['sex_code'])?>" <?= ($sex['sex_code'] == $pat_edit_sex) ? "selected" : "" ?>><?= esc($sex['sex'])?></option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="form-group pat_civilstatus">
                            ...
                            <select class="select-select2 form-control select-sm" id="pat_civilstatus" name="pat_civilstatus">
                                ...
                                <?php foreach($getcivilstatus as $cs): ?>
                                    <option value="<?= esc($cs['civil_status_code'])?>" <?= ($cs['civil_status_code'] == $pat_edit_cs) ? "selected" : "" ?>><?= esc($cs['civil_status'])?></option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="form-group pat_blood_type">
                            ...
                            <select class="select-select2 form-control select-sm" id="pat_blood_type" name="pat_blood_type">
                                ...
                                <?php foreach($getbloodtype as $bt): ?>
                                    <option value="<?= esc($bt['blood_code'])?>" <?= ($bt['blood_code'] == $pat_edit_blood) ? "selected" : "" ?>><?= esc($bt['blood_type'])?></option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="form-group pat_nationality">
                            ...
                            <select class="select-select2 form-control select-sm" id="pat_nationality" name="pat_nationality">
                                ...
                                <?php foreach($getnationality as $nation): ?>
                                    <option value="<?= esc($nation['nationality_code'])?>" <?= ($nation['nationality_code'] == $pat_edit_nationality) ? "selected" : "" ?>><?= esc($nation['nationality'])?></option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="form-group pat_religion">
                            ...
                            <select class="select-select2 form-control select-sm" id="pat_religion" name="pat_religion">
                                ...
                                <?php foreach($getreligion as $religion): ?>
                                    <option value="<?= esc($religion['religion_code'])?>" <?= ($religion['religion_code'] == $pat_edit_religion) ? "selected" : "" ?>><?= esc($religion['religion'])?></option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="pat_contact_mobile" name="pat_contact_mobile" class="form-control" placeholder="Mobile Number, eg: 0999 999 9999" autocomplete="false" value="<?= $pat_edit_mobile ?>">
                                </div>
                                <div class="form-group">
                                    <label for="pat_contact_telephone" class="control-label">Telephone Number</label>
                                    <input type="text" id="pat_contact_telephone" name="pat_contact_telephone" class="form-control" placeholder="Telephone Number, eg: (072) 222 9999" autocomplete="false" value="<?= $pat_edit_tel ?>">
                                </div>
                                <div class="form-group">
                                    <label for="pat_contact_email" class="control-label">Email Address</label>
                                    <input type="text" id="pat_contact_email" name="pat_contact_email" class="form-control" placeholder="Email Address, eg: ilocos@ilocos.doh.gov.ph" autocomplete="false" value="<?= $pat_edit_email ?>">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="pat_contact_person_name" name="pat_contact_person_name" class="form-control" placeholder="Contact Name" autocomplete="false" value="<?= $pat_edit_ref_name ?>">
                                </div>
                                <div class="form-group">
                                    <label for="pat_contact_person_address" class="control-label">Contact Address</label>
                                    <textarea class="form-control" id="pat_contact_person_address" name="pat_contact_person_address" placeholder="Contact Address" autocomplete="false"> <?= $pat_edit_ref_address ?></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="pat_contact_person_mobile" class="control-label">Contact Number</label>
                                    <input type="text" id="pat_contact_person_mobile" name="pat_contact_person_mobile" class="form-control" placeholder="Contact Number" autocomplete="false" value="<?= $pat_edit_ref_number ?>">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="form-group pat_current_street">
                    ...
                    <textarea class="form-control" name="pat_current_street" id="pat_current_street" placeholder="Street/House No./Building No./Purok"><?= $pat_edit_cur_street ?></textarea>
                ...
                <div class="form-group pat_current_city">
                    ...
                    <select class="select-select2 form-control select-sm" id="pat_current_city" name="pat_current_city">
                        ...
                        <?php foreach($getmuncity as $muncity): ?>
                            <option value="<?= esc($muncity['city_code'])?>" <?= ($muncity['city_code'] == $pat_edit_cur_city) ? "selected" : "" ?>><?= esc($muncity['city']) . ' ('.esc($muncity['province']).')'?></option>
                        <?php endforeach; ?>
                    </select>
            ...
            <div class="col-sm-3">
                <div class="form-group pat_current_brgy">
                    ...
                    <select id="pat_current_brgy" name="pat_current_brgy" class="form-control select-select2" placeholder="Barangay">
                        <option value="">Select option</option>
                        <?php foreach($getbrgy as $brgy): ?>
                            <option value="<?= esc($brgy['brgy_code'])?>" <?= ($brgy['brgy_code'] == $pat_edit_cur_brgy) ? "selected" : "" ?>><?= esc($brgy['brgy']) ?></option>
                        <?php endforeach; ?>
                    </select>
            ...
            <div class="col-sm-3">
                <div class="form-group pat_current_district">
                    ...
                    <select id="pat_current_district" name="pat_current_district" class="form-control select-select2" placeholder="District" <?= $pat_edit_cur_district_true ?>>
                        <option value="">Select option</option>
                        <?php foreach($getdistrict as $district): ?>
                            <option value="<?= esc($district['district_code'])?>" <?= ($district['district_code'] == $pat_edit_cur_district) ? "selected" : "" ?>><?= esc($district['district']) ?></option>
                        <?php endforeach; ?>
                    </select>
            ...
            <div class="col-sm-2">
                <div class="form-group pat_current_zip">
                    ...
                    <input type="text" id="pat_current_zip" name="pat_current_zip" class="form-control" placeholder="Zip Code" value="<?= $pat_edit_cur_zip ?>">
                ...
                <div class="form-group pat_current_province">
                    ...
                    <select id="pat_current_province" name="pat_current_province" class="form-control select-select2" disabled>
                        ...
                        <?php foreach($getprovince as $getprov): ?>
                            <option value="<?= esc($getprov['province_code'])?>" <?= ($getprov['province_code'] == $pat_edit_cur_province) ? "selected" : "" ?>><?= esc($getprov['province']) ?></option>
                        <?php endforeach; ?>
                    </select>
                ...
                <div class="form-group pat_current_region">
                    ...
                    <option value="">Select option</option>
                        <?php foreach($getregion as $getreg): ?>
                            <option value="<?= esc($getreg['region_code'])?>" <?= ($getreg['region_code'] == $pat_edit_cur_region) ? "selected" : "" ?>><?= esc($getreg['region']) ?></option>
                        <?php endforeach; ?>
                    </select>
        ...
        <div class="row mb-4">
            <div class="col-sm-12">
                <label class="csscheckbox csscheckbox-primary"><input type="checkbox" id="same_address" name="same_address" <?= $pat_same_address ?>><span></span> <em class="text-primary">Check this if Current and Permanent address is the same.</em></label>
            </div>
        </div>
        <br>
        <div id="div_permanent_address" <?= ($pat_div_permanent_address) ? 'style="display: none;"' : '' ?>>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group pat_permanent_street">
                        ...
                        <textarea class="form-control" name="pat_permanent_street" id="pat_permanent_street" placeholder="Street/House No./Building No./Purok"><?= $pat_edit_per_street ?></textarea>
                ...
                <div class="col-sm-4">
                    <div class="form-group pat_permanent_city">
                        ...
                        <select class="select-select2 form-control select-sm" id="pat_permanent_city" name="pat_permanent_city" style="width:100%">
                            <option value="">Select option</option>
                            <?php foreach($getmuncity as $muncity): ?>
                                <option value="<?= esc($muncity['city_code'])?>" <?= ($muncity['city_code'] == $pat_edit_per_city) ? "selected" : "" ?>><?= esc($muncity['city']) . ' ('.esc($muncity['province']).')'?></option>
                            <?php endforeach; ?>
                        </select>
                ...
                <div class="col-sm-3">
                    <div class="form-group pat_permanent_brgy">
                        ...
                        <select id="pat_permanent_brgy" name="pat_permanent_brgy" class="form-control select-select2" placeholder="Barangay" style="width:100%">
                            <option value="">Select option</option>
                            <?php foreach($getbrgy as $brgy): ?>
                                <option value="<?= esc($brgy['brgy_code'])?>" <?= ($brgy['brgy_code'] == $pat_edit_per_brgy) ? "selected" : "" ?>><?= esc($brgy['brgy']) ?></option>
                            <?php endforeach; ?>
                        </select>
                ...
                <div class="col-sm-3">
                    <div class="form-group pat_permanent_district">
                        ...
                        <select id="pat_permanent_district" name="pat_permanent_district" class="form-control select-select2" placeholder="District" style="width:100%" <?= $pat_edit_per_district_true ?>>
                        <option value="">Select option</option>
                        <?php foreach($getdistrict as $district): ?>
                            <option value="<?= esc($district['district_code'])?>" <?= ($district['district_code'] == $pat_edit_per_district) ? "selected" : "" ?>><?= esc($district['district']) ?></option>
                        <?php endforeach; ?>
                        </select>
                ...
                <div class="col-sm-2">
                    <div class="form-group pat_permanent_zip">
                        ...
                        <input type="text" id="pat_permanent_zip" name="pat_permanent_zip" class="form-control" placeholder="Zip Code" style="width:100%" value="<?= $pat_edit_per_zip ?>">
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="form-group pat_permanent_province">
                        ...
                        <select id="pat_permanent_province" name="pat_permanent_province" class="form-control select-select2" style="width:100%" disabled>
                            <option value="">Select option</option>
                            <?php foreach($getprovince as $getprov): ?>
                                <option value="<?= esc($getprov['province_code'])?>"  <?= ($getprov['province_code'] == $pat_edit_per_province) ? "selected" : "" ?>><?= esc($getprov['province']) ?></option>
                            <?php endforeach; ?>
                        </select>
                ...
                <div class="col-sm-4">
                    <div class="form-group pat_permanent_region">
                        ...
                        <select id="pat_permanent_region" name="pat_permanent_region" class="form-control select-select2" style="width:100%" disabled>
                            <option value="">Select option</option>
                            <?php foreach($getregion as $getreg): ?>
                                <option value="<?= esc($getreg['region_code'])?>" <?= ($getreg['region_code'] == $pat_edit_per_region) ? "selected" : "" ?>><?= esc($getreg['region']) ?></option>
                            <?php endforeach; ?>
                        </select>
                ...
                <div class="col-sm-4">
                    <div class="form-group pat_permanent_country">
                        ...
                        <select id="pat_permanent_country" name="pat_permanent_country" class="form-control select-select2" style="width:100%" disabled>
                            <option value=""></option>
                            <option value="Philippines" selected>PHILIPPINES</option>
                        </select>
